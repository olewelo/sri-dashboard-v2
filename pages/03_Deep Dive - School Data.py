...
with tab3:
    ...
    st.markdown("""
                The SRI's school location data was evaluated for quality using a stratified sample of countries, selected across regions 
                and income groups. Two countries per stratum were chosen—one with a high, one with a low number of schools relative to the country's 
                child population—based on data availability. The SRI data's total number of schools in each sample country was compared to official 
                government data on school numbers to assess the quality of the SRI school coverage. On average, the SRI data covers 53 percent of schools in the sample countries, 
                with considerable variation across regions and income groups.
    """)
